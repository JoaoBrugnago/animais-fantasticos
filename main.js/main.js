...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initMenuMobile)\n/* harmony export */ });\n/* harmony import */ var _outsideclick_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outsideclick.js */ \"./modules/outsideclick.js\");\n\nfunction initMenuMobile() {\n  var menuButton = document.querySelector('[data-menu=\"button\"]');\n  var menulist = document.querySelector('[data-menu=\"list\"]');\n  if (menuButton) {\n    var openMenu = function openMenu(event) {\n      menulist.classList.add(\"active\");\n      menuButton.classList.add(\"active\");\n      (0,_outsideclick_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(menulist, [\"touchstart\", \"click\"], function () {\n        menulist.classList.remove(\"active\");\n        menuButton.classList.remove(\"active\");\n      });\n    };\n    [\"touchstart\", \"click\"].forEach(function (user) {\n      menuButton.addEventListener(user, openMenu);\n    });\n  }\n}\n\n//# sourceURL=webpack://animais-eslint/./modules/menu-mobile.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initAnimacaoScroll)\n/* harmony export */ });\nfunction initAnimacaoScroll() {\n  var sections = document.querySelectorAll(\"[data-anime='scroll']\");\n  if (sections.length) {\n    var animaScroll = function animaScroll() {\n      sections.forEach(function (section) {\n        var sectionTop = section.getBoundingClientRect().top - windowTamanho;\n        if (sectionTop < 0) {\n          section.classList.add(\"ativo\");\n        } else if (section.classList.contains(\"ativo\")) {\n          section.classList.remove(\"ativo\");\n        }\n      });\n    };\n    var windowTamanho = window.innerHeight * 0.6;\n    animaScroll();\n    window.addEventListener(\"scroll\", animaScroll);\n  }\n}\n\n//# sourceURL=webpack://animais-eslint/./modules/scroll-animacao.js?");
